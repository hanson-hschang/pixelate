...
class ImageGenerator:
    ...
    def generate_pixel_image(self, color_dict: Dict[str, str], pixel_grid: List[List[str]], 
        ...
        image: Image.Image = Image.new('RGBA', (img_width, img_height), (255, 255, 255, 0))  # Transparent background
        ...
        for row_idx, row in enumerate(pixel_grid):
            for col_idx, cell_value in enumerate(row):
                ...
                if cell_value in color_dict:
                    ...
                    try:
                        rgba_color: Tuple[int, int, int, int] = self.hex_to_rgba(hex_color)
...
class FileProcessor:
    ...
    def process_markdown_file(self, markdown_file: Path, output_dir: Optional[Path] = None, 
        ...
        try:
            ...
            self._generator.generate_pixel_image(color_dict, pixel_grid, output_path, pixel_size, format)
