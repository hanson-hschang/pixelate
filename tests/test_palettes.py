...
from pixelate.palette import PALETTES, resolve_color
...
class TestResolveColor:
    ...
    def test_unknown_tableau_color(self) -> None:
        ...
        with pytest.raises(
            ValueError, match="Unknown color 'unknown' in palette 'tableau'"
        ):
    ...
    def test_unknown_xkcd_color(self) -> None:
        ...
        with pytest.raises(
            ValueError, match="Unknown color 'unknown' in palette 'xkcd'"
        ):
